<template>
  <TransitionRoot as="template" :show="showingGeolocationDialog">
              ...
              <div>
                ...
                <div class="mt-3 text-center sm:mt-5">
                  <DialogTitle
                    ...
                    >Requesting geo-location...
                  </DialogTitle>
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
                      We need to access your location to save the inspection
                      data.
                    </p>
                  </div>
                </div>
...
const showingGeolocationDialog = defineModel({
  type: Boolean,
  default: false,
})
